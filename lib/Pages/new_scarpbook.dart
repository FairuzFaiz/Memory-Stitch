      ...
      body: Container(  
        decoration: BoxDecoration(  
          image: DecorationImage(  
            image: AssetImage('assets/scrapbook_bg.jpg'), // Ganti dengan nama file gambar latar belakang  
            fit: BoxFit.cover,  
          ),  
        ),  
        child: Padding(  
                    ...
                    showDialog(  
                      ...
                      builder: (BuildContext context) {  
                        return AlertDialog(  
                          ...
                          content: const Text('Apakah Anda yakin ingin memilih template ini?'),  
                          actions: [  
                            TextButton(  
                              onPressed: () {  
                            ...
                            TextButton(  
                              onPressed: () {  
                                ...
                                Navigator.push(  
                                  context,  
                                  MaterialPageRoute(  
                                    builder: (context) => NewInputScrapbookPage(templateIndex: index),  
                                  ),  
                                );  
                              },  
                              child: const Text('Ya'),  
